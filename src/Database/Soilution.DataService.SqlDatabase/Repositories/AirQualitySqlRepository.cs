...
namespace Soilution.DataService.SqlRepository.Repositories
{
    ...
    /// </summary>
    internal class AirQualitySqlRepository : DatabaseAccessor, IAirQualityDataRepository
    {
        ...
        public AirQualitySqlRepository(ILogger<AirQualitySqlRepository> logger, 
